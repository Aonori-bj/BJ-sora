...
my @bonus = (
#	['weapon', 33, 0, 0], # ﾐｻｲﾙ
	['weapon', 31, 0, 0], # ﾄﾞﾚｲﾉｸｻﾘ　ﾐｻｲﾙ実装までのつなぎbyあおのり
	['money', 1000000, 0, 0],
	['money', 500000, 0, 0],
	['money', 100000, 0, 0],
	['money', 50000, 0, 0],
...
# ﾎﾞｽのｽｲｯﾁをｵﾌにすると以下の卵しか出てこない
# ひとまずそれは置いておくとして、ﾎﾞｽの出てこない討伐地でも以下の卵しか出てこなくなるのは問題ありか
# ｱﾋﾞﾘﾃｨｴｯｸﾞ ｳｨﾝﾄﾞｴｯｸﾞ ﾑｰﾝｴｯｸﾞ ﾌｧｲｱｰｴｯｸﾞ ｳｫｰﾀｰｴｯｸﾞ ﾂﾘｰｴｯｸﾞ ｻﾝﾀﾞｰｴｯｸﾞ ｱｰｽｴｯｸﾞ ﾀﾞｰｸｴｯｸﾞ ﾗｲﾄｴｯｸﾞ ﾌﾟﾗﾁﾅｴｯｸﾞ ｼﾙﾊﾞｰｴｯｸﾞ
# ｽｷﾙｴｯｸﾞ ﾌﾟﾘﾃｨｴｯｸﾞ ｸｰﾙｴｯｸﾞ ｽｰﾊﾟｰｴｯｸﾞ ﾚｲﾝﾎﾞｰｴｯｸﾞ ﾚｼﾞｪﾝﾄﾞｴｯｸﾞ ｱﾝﾃﾞｯﾄｴｯｸﾞ ﾏｼﾞｯｸｴｯｸﾞ ﾌﾞﾗｯﾄﾞｴｯｸﾞ
# ｸﾘｽﾀﾙｴｯｸﾞ ﾃﾞﾋﾞﾙｴｯｸﾞ ﾊﾟﾝﾄﾞﾗｴｯｸﾞ ﾎｯﾄｴｯｸﾞ ｺﾞｰﾙﾄﾞｴｯｸﾞ
...
sub _get_item {
	...
	my $ltime = time();
	open my $fh, ">> $logdir/hunt_log.cgi";
	print $fh "$m{name}<>$places[$m{stock}][2]<>$eggs[$egg_no][1]<>$is_get<>$ltime\n";
	close $fh;
}
