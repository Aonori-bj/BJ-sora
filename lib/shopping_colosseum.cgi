...
my @menus = (
#	[0]–¼‘O,[1]‹­‚³§ŒÀ,[2]–h‰q‹à,[3]oê‹à
	['ËßÖËßÖØ°¸Ş',	800,	1000,	1000],
	['ËŞ·ŞÅ°Ø°¸Ş',	1500,	1000,	1000],
	['ÍŞÃ×İØ°¸Ş',	3000,	2000,	2000],
	['Ï¼Ş¼¬İØ°¸Ş',	0,		2000,	2000],
	['¿Ù¼Ş¬°Ø°¸Ş',	0,		2000,	2000],
	['Á¬İËßµİØ°¸Ş',	0,		3000,	3000],
);
...
sub champ_statuses {
	...
	for my $line (@lines) {
		...
		$mes .= "$round_titles[$round_c]:$name(–h‰q$defence_c)/$weas[$wea][1]/$e2j{hp}$max_hp/$e2j{mp}$max_mp/$e2j{at}$at/$e2j{df}$df/$e2j{mat}$mat/$e2j{mdf}$mdf/$e2j{ag}$ag<br>";
		--$count;
	}
}
