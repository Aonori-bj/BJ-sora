...
#require './admin_password.cgi';(nyaa鯖ではこれを使用していた)
$admin_pass = '';#consealed by あおのり 2020/8/16
...
@nolog_lists = (
	'114-134-194-186.fnnr.j-cnet.jp',
);
