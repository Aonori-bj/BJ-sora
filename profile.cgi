...
sub status_mobile {
	...
	print qq|<font color="#9999CC">•Ší:[$weas[$m{wea}][2]]$weas[$m{wea}][1]š<b>$m{wea_lv}</b></font><br>| if $m{wea};
...
sub status_pc {
	...
	print <<"EOM";
		...
		$units[$m{unit}][1]
		<hr size="1" width="90%">
			<font color="#9999CC">•ŠíF[$weas[$m{wea}][2]]$weas[$m{wea}][1]š<b>$m{wea_lv}</b></font><br>
